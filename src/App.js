      ...
      <footer>
        <div className="footer">
          ...
          <div className="footer-websurfer">
            <span className="footer-websurfer_build">
              Сделано <a href="#">"ВАШЕ ИМЯ"</a>
            </span> 
          </div>
